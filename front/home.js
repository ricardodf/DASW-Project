...
function getUser(correo, password){
    ...
    var url = `dasw-application.herokuapp.com/api/users/?correo=${correo}&password=${password}`;
    xhr.open('GET', url);
    xhr.send();
    xhr.onload = function(){
...
function loadSession(id){
    ...
    var xhr = new XMLHttpRequest();
    var url = `dasw-application.herokuapp.com/api/token`;
    xhr.open('PUT', url);
...
function registerNewUser(user){
    var xhr = new XMLHttpRequest();
    var url = "dasw-application.herokuapp.com/api/users";
    xhr.open('POST', url);
    xhr.setRequestHeader('Content-Type', 'application/json');
